  ...
  fromJSON(object: any): Geometry {
    return {
      geometry: isSet(object.point)
        ...
        : isSet(object.multi_point)
        ? { $case: "multiPoint", multiPoint: MultiPoint.fromJSON(object.multi_point) }
        : isSet(object.multiLine)
        ? { $case: "multiLine", multiLine: MultiLine.fromJSON(object.multiLine) }
        : isSet(object.multi_line)
        ? { $case: "multiLine", multiLine: MultiLine.fromJSON(object.multi_line) }
        : isSet(object.multiPolygon)
        ? { $case: "multiPolygon", multiPolygon: MultiPolygon.fromJSON(object.multiPolygon) }
        : isSet(object.multi_polygon)
        ? { $case: "multiPolygon", multiPolygon: MultiPolygon.fromJSON(object.multi_polygon) }
  ...
  fromJSON(object: any): Value {
    return {
      value: isSet(object.null)
        ...
        ? { $case: "recordId", recordId: RecordId.fromJSON(object.record_id) }
        : isSet(object.stringRecordId)
        ? { $case: "stringRecordId", stringRecordId: globalThis.String(object.stringRecordId) }
        : isSet(object.string_record_id)
        ? { $case: "stringRecordId", stringRecordId: globalThis.String(object.string_record_id) }
        : isSet(object.file)
  ...
  fromJSON(object: any): FunctionKind {
    return {
      ...
      returnType: isSet(object.returnType)
        ? Kind.fromJSON(object.returnType)
        : isSet(object.return_type)
        ? Kind.fromJSON(object.return_type)
        : undefined,
    };
  },
...
export const LiteralDiscriminatedObject: MessageFns<LiteralDiscriminatedObject> = {
  ...
  fromJSON(object: any): LiteralDiscriminatedObject {
    return {
      discriminantKey: isSet(object.discriminantKey)
        ? globalThis.String(object.discriminantKey)
        : isSet(object.discriminant_key)
        ? globalThis.String(object.discriminant_key)
        : "",
  ...
  fromJSON(object: any): LiteralKind {
    return {
      literal: isSet(object.stringValue)
        ...
        ? { $case: "durationValue", durationValue: Duration.fromJSON(object.duration_value) }
        ...
        ? { $case: "arrayValue", arrayValue: LiteralArray.fromJSON(object.array_value) }
        : isSet(object.objectValue)
        ? { $case: "objectValue", objectValue: LiteralObject.fromJSON(object.objectValue) }
        : isSet(object.object_value)
        ? { $case: "objectValue", objectValue: LiteralObject.fromJSON(object.object_value) }
        ...
        : isSet(object.discriminated_object_value)
        ? {
          $case: "discriminatedObjectValue",
          discriminatedObjectValue: LiteralDiscriminatedObject.fromJSON(object.discriminated_object_value),
        }
        : undefined,
    };
  },
