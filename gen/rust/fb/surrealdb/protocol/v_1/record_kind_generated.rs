...
impl<'a> RecordKind<'a> {
  ...
  #[inline]
  pub fn tables(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TableName<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TableName>>>>(RecordKind::VT_TABLES, None)}
  }
}
...
impl flatbuffers::Verifiable for RecordKind<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<TableName>>>>("tables", Self::VT_TABLES, false)?
     .finish();
    Ok(())
  }
}
pub struct RecordKindArgs<'a> {
    pub tables: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TableName<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RecordKindBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_tables(&mut self, tables: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<TableName<'b >>>>) {
