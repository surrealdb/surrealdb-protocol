...
pub struct CreateResponse {
    #[prost(message, optional, tag="1")]
    pub document: ::core::option::Option<super::super::v1::Document>,
}
...
pub struct SelectResponse {
    #[prost(message, optional, tag="1")]
    pub documents: ::core::option::Option<DocumentBatch>,
}
...
pub struct DocumentBatch {
    ...
    pub documents: ::prost::alloc::vec::Vec<super::super::v1::Document>,
}
impl ::prost::Name for DocumentBatch {
const NAME: &'static str = "DocumentBatch";
const PACKAGE: &'static str = "surrealdb.protocol.rpc.v1";
fn full_name() -> ::prost::alloc::string::String { "surrealdb.protocol.rpc.v1.DocumentBatch".into() }fn type_url() -> ::prost::alloc::string::String { "/surrealdb.protocol.rpc.v1.DocumentBatch".into() }}
#[derive(Clone, PartialEq, ::prost::Message)]
