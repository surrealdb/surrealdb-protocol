...
pub struct Document {
    #[prost(message, optional, tag="1")]
    pub data: ::core::option::Option<Value>,
}
impl ::prost::Name for Document {
const NAME: &'static str = "Document";
const PACKAGE: &'static str = "surrealdb.protocol.v1";
fn full_name() -> ::prost::alloc::string::String { "surrealdb.protocol.v1.Document".into() }fn type_url() -> ::prost::alloc::string::String { "/surrealdb.protocol.v1.Document".into() }}
#[derive(Clone, PartialEq, ::prost::Message)]
...
impl ::prost::Name for MethodPart {
const NAME: &'static str = "MethodPart";
const PACKAGE: &'static str = "surrealdb.protocol.v1";
fn full_name() -> ::prost::alloc::string::String { "surrealdb.protocol.v1.MethodPart".into() }fn type_url() -> ::prost::alloc::string::String { "/surrealdb.protocol.v1.MethodPart".into() }}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Ident {
    #[prost(string, tag="1")]
    pub value: ::prost::alloc::string::String,
