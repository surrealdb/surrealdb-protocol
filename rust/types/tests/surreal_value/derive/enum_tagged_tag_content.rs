...
fn test_enum_tagged_with_tag_and_content() {
    ...
    // is_value
    assert!(EnumTaggedWithTagAndContent::is_value(&Value::Object(
        object! {
...
fn test_enum_tagged_with_tag_variant_baz() {
    ...
    assert_eq!(
        converted,
        EnumTaggedWithTagAndContent::Baz("baz".to_string())
    );
...
fn test_enum_tagged_with_tag_variant_qux() {
    ...
    assert_eq!(
        converted,
        EnumTaggedWithTagAndContent::Qux("qux".to_string(), 1)
    );
...
fn test_enum_tagged_with_tag_variant_lowercase() {
    ...
    // is_value
    assert!(EnumTaggedWithTagAndContentLowercase::is_value(
        &Value::Object(
            object! { tag: Value::String("foo".to_string()), content: Value::Object(object! {}) }
        )
    ));
...
fn test_enum_tagged_with_tag_variant_uppercase() {
    ...
    // is_value
    assert!(EnumTaggedWithTagAndContentUppercase::is_value(
        &Value::Object(
            object! { tag: Value::String("FOO".to_string()), content: Value::Object(object! {}) }
        )
    ));
