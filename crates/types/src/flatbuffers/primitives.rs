...
impl ToFlatbuffers for bool {
    ...
    fn to_fb<'bldr>(
        ...
        Ok(proto_fb::BoolValue::create(
            builder,
            &proto_fb::BoolValueArgs { value: *self },
        ))
    }
}
...
impl ToFlatbuffers for i64 {
    ...
    fn to_fb<'bldr>(
        ...
        Ok(proto_fb::Int64Value::create(
            builder,
            &proto_fb::Int64ValueArgs { value: *self },
        ))
    }
}
...
impl ToFlatbuffers for u64 {
    ...
    fn to_fb<'bldr>(
        ...
        Ok(proto_fb::UInt64Value::create(
            builder,
            &proto_fb::UInt64ValueArgs { value: *self },
        ))
    }
}
...
impl ToFlatbuffers for f64 {
    ...
    fn to_fb<'bldr>(
        ...
        Ok(proto_fb::Float64Value::create(
            builder,
            &proto_fb::Float64ValueArgs { value: *self },
        ))
    }
}
...
impl ToFlatbuffers for String {
    ...
    fn to_fb<'bldr>(
        ...
        Ok(proto_fb::StringValue::create(
            builder,
            &proto_fb::StringValueArgs { value: Some(value) },
        ))
    }
}
...
impl ToFlatbuffers for Decimal {
    ...
    fn to_fb<'bldr>(
        ...
        Ok(proto_fb::Decimal::create(
            builder,
            &proto_fb::DecimalArgs { value: Some(value) },
        ))
    }
}
...
impl ToFlatbuffers for Uuid {
    ...
    fn to_fb<'bldr>(
        ...
        Ok(proto_fb::Uuid::create(
            builder,
            &proto_fb::UuidArgs { bytes: Some(bytes) },
        ))
    }
}
...
impl FromFlatbuffers for Uuid {
    ...
    #[inline]
    fn from_fb(input: Self::Input<'_>) -> anyhow::Result<Self> {
        let bytes_vector = input
            .bytes()
            .ok_or_else(|| anyhow::anyhow!("Missing bytes in Uuid"))?;
...
impl ToFlatbuffers for Bytes {
    ...
    fn to_fb<'bldr>(
        ...
        Ok(proto_fb::Bytes::create(
            builder,
            &proto_fb::BytesArgs { value: Some(data) },
        ))
    }
}
...
impl FromFlatbuffers for Bytes {
    ...
    fn from_fb(input: Self::Input<'_>) -> anyhow::Result<Self> {
        let data = input
            .value()
            .ok_or_else(|| anyhow::anyhow!("Missing value in Bytes"))?;
