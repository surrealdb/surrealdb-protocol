                ...
                proto_fb::KindArgs {
                    ...
                    kind: Some(
                        proto_fb::GeometryKind::create(
                            builder,
                            &proto_fb::GeometryKindArgs { types: Some(types) },
                        )
                        .as_union_value(),
                    ),
                }
                ...
                proto_fb::KindArgs {
                    ...
                    kind: Some(
                        proto_fb::EitherKind::create(
                            builder,
                            &proto_fb::EitherKindArgs { kinds: Some(kinds) },
                        )
                        .as_union_value(),
                    ),
                }
                ...
                proto_fb::KindArgs {
                    ...
                    kind: Some(
                        proto_fb::FunctionKind::create(
                            builder,
                            &proto_fb::FunctionKindArgs { args, return_type },
                        )
                        .as_union_value(),
                    ),
                }
    ...
    fn to_fb<'bldr>(
        ...
        let args = match self {
            Self::Bool(bool) => proto_fb::LiteralKindArgs {
                ...
                literal: Some(
                    proto_fb::BoolValue::create(builder, &proto_fb::BoolValueArgs { value: *bool })
                        .as_union_value(),
                ),
            },
            Self::String(string) => {
            ...
            Self::Integer(i) => proto_fb::LiteralKindArgs {
                ...
                literal: Some(
                    proto_fb::Int64Value::create(builder, &proto_fb::Int64ValueArgs { value: *i })
                        .as_union_value(),
                ),
            },
            Self::Float(f) => proto_fb::LiteralKindArgs {
                ...
                literal: Some(
                    proto_fb::Float64Value::create(
                        builder,
                        &proto_fb::Float64ValueArgs { value: *f },
                    )
                    .as_union_value(),
                ),
            },
